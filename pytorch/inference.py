...
def inference(args):
    ...
    # Paths
    filename = os.path.splitext(os.path.basename(audio_path))[-2]
    # midi_path = os.path.join('results', f"{filename}.mid")
    midi_path = 'results/{}.mid'.format(filename)
    print("here")
    print(f"audio_path = {get_filename(audio_path)}")
